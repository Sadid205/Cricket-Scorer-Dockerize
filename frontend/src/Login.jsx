...
return (
<>
<div className="flex flex-col items-center min-h-screen pt-16 text-white bg-gray-700 sm:justify-center sm:pt-0">
<div style={{
          boxShadow:
          ...
          }} className='p-3 mx-auto mb-4 rounded-md w-96'>
  ...
  <div className="relative w-full max-w-lg mt-12 sm:mt-10">
    <div className="relative w-full h-px -mb-px bg-gradient-to-r from-transparent via-sky-300 to-transparent" bis_skin_checked={1} />
      ...
      <div className="p-6 pt-0">
        <form onSubmit={(e)=>handleSubmit(e)}>
          <div>
            <div>
              <div className="group relative rounded-lg border focus-within:border-sky-200 px-3 pb-1.5 pt-2.5 duration-200 focus-within:ring focus-within:ring-sky-300/30">
                ...
                <input value={username} onChange={(e)=>setUsername(e.target.value)} type="text" name="username" placeholder="Username" autoComplete="off" className="block w-full p-0 text-sm bg-transparent border-0 file:my-1 file:rounded-full file:border-0 file:bg-accent file:px-4 file:py-2 file:font-medium placeholder:text-muted-foreground/90 focus:outline-none focus:ring-0 sm:leading-7 text-foreground" />
              </div>
            </div>
          </div>
          <div className="mt-4">
            <div>
              <div className="group relative rounded-lg border focus-within:border-sky-200 px-3 pb-1.5 pt-2.5 duration-200 focus-within:ring focus-within:ring-sky-300/30">
                ...
                <div className="flex items-center">
                  <input value={password} onChange={(e)=>setPassword(e.target.value)} type="password" name="password" placeholder="Password" className="block w-full p-0 text-sm bg-transparent border-0 file:my-1 placeholder:text-muted-foreground/90 focus:outline-none focus:ring-0 focus:ring-teal-500 sm:leading-7 text-foreground" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center justify-end mt-4 gap-x-2">
            ...
            <button className="inline-flex items-center justify-center w-20 h-10 px-4 py-2 text-sm font-semibold text-black transition duration-300 bg-white rounded-md hover:bg-black hover:text-white hover:ring hover:ring-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50" type="submit">{loading?(<div className="animate-spin inline-block size-6 border-[3px] border-current border-t-transparent text-blue-600 rounded-full dark:text-blue-500" role="status" aria-label="loading">
